    ...
    return (
        <main>
            ...
            <div className="account-container">
                ...
                We are overjoyed to have you join our Casa del mar community. 
                Creating free account is your first step towards exploring infinite world of stylish
                 furnishings and latest trends in interior design. </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-row">
                             ...
                             <div className="accountcustom-text"> 
                                By signing up for a Casa del mar account you agree to our Privacy Policy and Terms of Service.   </div>
                                </div>
                                </div>
